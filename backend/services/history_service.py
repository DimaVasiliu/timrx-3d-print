                ...
                if existing_history_id:
                    ...
                    cur.execute(
                        ...
                        SET item_type = EXCLUDED.item_type,
                            ...
                            identity_id = COALESCE(EXCLUDED.identity_id, {Tables.HISTORY_ITEMS}.identity_id),
                            thumbnail_url = COALESCE(EXCLUDED.thumbnail_url, {Tables.HISTORY_ITEMS}.thumbnail_url),
                            video_url = COALESCE(EXCLUDED.video_url, {Tables.HISTORY_ITEMS}.video_url),
...
def save_finished_job_to_normalized_db(job_id: str, status_data: dict, job_meta: dict, job_type: str = "model", user_id: str | None = None):
    ...
    try:
        with get_conn(source="save_finished_job") as conn:
            ...
            root_prompt = job_meta.get("root_prompt") or final_prompt or texture_prompt_fallback
            ...
            payload = {
                ...
                "pose_mode": job_meta.get("pose_mode", ""),
                ...
                "height_meters": job_meta.get("height_meters"),
                "action_id": job_meta.get("action_id"),
                "post_process": job_meta.get("post_process"),
                ...
                "remove_lighting": job_meta.get("remove_lighting", True),
                "target_formats": job_meta.get("target_formats") or [],
                "ai_model": job_meta.get("ai_model") or "latest",
                "model_type": job_meta.get("model_type"),
                "moderation": bool(job_meta.get("moderation")),
                "auto_size": bool(job_meta.get("auto_size")),
                "texture_style_mode": job_meta.get("texture_style_mode") or "text",
                "uses_image_style": bool(job_meta.get("uses_image_style")),
                "topology": job_meta.get("topology"),
                "target_polycount": job_meta.get("target_polycount"),
                "resize_height": job_meta.get("resize_height"),
                "origin_at": job_meta.get("origin_at"),
                "convert_format_only": bool(job_meta.get("convert_format_only")),
                "print_height_mm": job_meta.get("print_height_mm"),
